"""
Script to generate test traffic for monitoring with Prometheus + Grafana.
Sends requests to localhost:8080 shop API endpoints with random data.

Note: Uses requests library (compatible with Python's standard ecosystem).
"""
import time
import random
import requests
