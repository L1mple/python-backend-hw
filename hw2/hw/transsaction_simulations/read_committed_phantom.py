"""
Demonstrate phantom read at READ COMMITTED in PostgreSQL.

Tx A (READ COMMITTED):
  - SELECT count(*) of products with price >= 150
  - Sleep, then SELECT count(*) again -> count changes due to concurrent insert
...
if __name__ == "__main__":
    ...
    print("Expect: Tx A counts differ -> phantom read at READ COMMITTED")
